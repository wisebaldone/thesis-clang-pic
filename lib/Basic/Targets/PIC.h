//===--- PIC.h - Declare PIC target feature support -------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares PIC TargetInfo objects.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_CLANG_LIB_BASIC_TARGETS_PIC_H
#define LLVM_CLANG_LIB_BASIC_TARGETS_PIC_H
...
// AVR Target
class LLVM_LIBRARY_VISIBILITY PICTargetInfo : public TargetInfo {
public:
  PICTargetInfo(const llvm::Triple &Triple, const TargetOptions &)
      : TargetInfo(Triple) {
    TLSSupported = false;
    PointerWidth = 16;
    PointerAlign = 8;
...
#endif // LLVM_CLANG_LIB_BASIC_TARGETS_PIC_H
